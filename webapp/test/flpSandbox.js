		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manage SAP Users",
									"targetURL": "#manageusmanageusers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"manageusmanageusers-display": {
								"semanticObject": "manageusmanageusers",
								"action": "display",
								"description": "Manage SAP Users",
								"title": "Manage SAP Users",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=manageus.manageusers",
									"url": sap.ui.require.toUrl("manageus/manageusers")
								}
							}
						}
					}
